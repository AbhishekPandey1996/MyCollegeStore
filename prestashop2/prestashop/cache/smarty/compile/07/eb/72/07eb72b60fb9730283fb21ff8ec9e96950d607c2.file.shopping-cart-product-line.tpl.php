<?php /* Smarty version Smarty-3.1.19, created on 2015-06-29 07:33:42
         compiled from "C:\wamp\www\prestashop2\prestashop\themes\default-bootstrap\shopping-cart-product-line.tpl" */ ?>
<?php /*%%SmartyHeaderCode:118715590d8b648bb82-88443727%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '07eb72b60fb9730283fb21ff8ec9e96950d607c2' => 
    array (
      0 => 'C:\\wamp\\www\\prestashop2\\prestashop\\themes\\default-bootstrap\\shopping-cart-product-line.tpl',
      1 => 1425623960,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '118715590d8b648bb82-88443727',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5590d8b8afba73_05062908',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5590d8b8afba73_05062908')) {function content_5590d8b8afba73_05062908($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\wamp\\www\\prestashop2\\prestashop\\tools\\smarty\\plugins\\modifier.replace.php';
if (!is_callable('smarty_modifier_regex_replace')) include 'C:\\wamp\\www\\prestashop2\\prestashop\\tools\\smarty\\plugins\\modifier.regex_replace.php';
?>
...
<?php $_tmp42=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp40."&amp;ipa=".$_tmp41."&amp;id_address_delivery=".$_tmp42."&amp;op=down&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp45=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp43."&amp;ipa=".$_tmp44."&amp;id_address_delivery=".$_tmp45."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp48=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp46."&amp;ipa=".$_tmp47."&amp;id_address_delivery=".$_tmp48."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
